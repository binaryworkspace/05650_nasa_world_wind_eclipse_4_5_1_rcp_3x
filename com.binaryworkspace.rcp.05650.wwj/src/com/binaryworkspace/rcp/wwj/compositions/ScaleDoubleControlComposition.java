 ...
 * 
 */
public class ScaleDoubleControlComposition implements IComposition {

	private final DecimalFormat DECIMAL_FORMATTER = new DecimalFormat("#0.0");

	private Composite parent;

	private IScaleDoubleControlComposition ref;
	...
	private final ScaleDoubleType TYPE;

	public ScaleDoubleControlComposition(Composite parent, IScaleDoubleControlComposition ref, double minValue, double maxValue, double increment, double initialValue, ScaleDoubleType scaleDoubleType) {
		this.parent = parent;
		this.ref = ref;
	...
	public void init() {
		...
		headerLabel.setText(TYPE.getPrefixTitle() + " " + DECIMAL_FORMATTER.format(value) + " " + TYPE.getPostfixTitle());
		...
		minAltitudeLabel.setText(DECIMAL_FORMATTER.format(MIN_VALUE));
		...
		maxAltitudeLabel.setText(DECIMAL_FORMATTER.format(MAX_INDEX * INCREMENT));
	...
	private void refresh() {
		...
		headerLabel.setText(TYPE.getPrefixTitle() + " " + DECIMAL_FORMATTER.format(value) + " " + TYPE.getPostfixTitle());
		ref.refreshScaleDoubleValue(TYPE, value);
		parent.layout();
	}
